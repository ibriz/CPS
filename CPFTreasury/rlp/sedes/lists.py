...
def is_sequence(obj):
    ...
    return isinstance(obj, (list, tuple)) and not (
            isinstance(obj, str) or isinstance(obj, (bytes, bytearray)))
...
class List(list):
    ...
    def serialize(self, obj):
        return list(self._serialize(obj))
    ...
    def deserialize(self, serial):
        return tuple(self._deserialize(serial))
