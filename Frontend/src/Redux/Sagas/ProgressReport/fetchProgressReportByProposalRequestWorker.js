...
import {fetchProgressReportByProposalSuccess, fetchProgressReportByProposalFailure} from '../../Reducers/progressReportSlice';
...
// }
    yield put(fetchProgressReportByProposalSuccess({
      response,
    }));
  } catch (error) {
