...
const ProposalIntro = () => {
    return (
        <div className = {styles.proposalIntro}>
            ...
            <div style = {{marginTop: '15px'}}>Discuss proposal ideas on the ICON Forum- <a href = "https://forum.icon.community/" target = "_blank" style = {{color: 'white', textDecoration: 'underline'}}>ICON Forum</a></div>
        </div>
    )
}
