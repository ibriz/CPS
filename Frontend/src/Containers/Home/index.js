    ...
    return (
        <div className={styles.home}>
...

            {
                ...
                <span className={styles.proposalTitle} style = {{paddingLeft: '7px', paddingRight: '7px'}}>
                    {(period === 'VOTING') ? 
                    'Voting Period ends in ' : 
                    'Application Period ends in  '}<b>{remainingTime.day}</b> days <b>{remainingTime.hour}</b> hours <b>{remainingTime.minute}</b> minutes <b>{remainingTime.second}</b> seconds
                </span>
                </div>
            }
            {
