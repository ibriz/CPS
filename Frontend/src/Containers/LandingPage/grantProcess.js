            ...
            <ul>
              ...
              <li className='current'>
                ...
                <p>
                  ...
                  Improve your chances in this stage by answering questions and
                  advocating for your idea.
                </p>
              </li>
              <li className='current '>
                ...
                <p>
                  ...
                  will have 15 days (the length of the next application period),
                  to submit a{' '}
                  <a
              ...
              <li className='current'>
                ...
                <p>
                  ...
                  now build your project, and after submitting progress reports
                  that are accepted, you will receive funding for your hard
                  work. After you complete your project, it's time to submit a
                  new idea and continue to grow the ICON ecosystem!
                </p>
              </li>
            </ul>
          </div>
