...
},
{
    "image": icon18nLogo,
    "title": "ICON i18n",
    "description": "Aims to expand the reach of the ICON Ecosystem into Spanish, Hindi and Korean speaking communities.",
    "link": "https://craft.network/",
    "disabled": true
},
{
...
},
{
    "image": icxRelayLogo,
    "title": "ICXRelay.app",
    "description": "ICX relay is a tool that will allow the transfer of ICX and IRC2 tokens to email and mobile phone recipients, allowing users who may not be familiar with cryptocurrency to be anonymously sent ICX or IRC2 tokens only they can claim",
...
},
{
    ...
    "description": "Web platform where anyone can easily create and deploy an IRC-2 or an IRC-3 SCORE directly from their browser.",
...
},
{
    "image": codaLogo,
    "title": "CODA",
    "description": "A web platform that allows musicians to tokenize musical works, sell musical works, collaborate with other creators, and seek funding for their ideas.",
    "link": "https://iconweb.studio/",
    "disabled": true
},
{
    ...
    "title": "ICON Reviews",
    "description": "Application trying to solve voter apathy and vote stagnation on ICON",
...
},
{
    "image": cpsBotLogo,
    "title": "ICON CPS Bot",
    "description": "Follow to get all the updates on ICON CPS (http://cps.icon.community).",
