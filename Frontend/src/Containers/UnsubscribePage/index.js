...
const UnsubscribePage = ({hasAddress}) => {
    ...
    return (
        ...
        <Container style = {{color: '#262626'}}>
            ...
            <div className = {styles.confirmationMessage}>Are you sure you want to opt out of the email list for the wallet address <span style = {{fontWeight: '600'}}>{walletAddress}</span></div>
            <div className = {styles.optOutButtonContainer}>
                <Button variant = "primary" className = {styles.optOutButton} onClick = {onClickOptOut}>Yes, I would like to opt out.</Button>
            </div>
        </Container>
        <Footer console/>
