...
function DetailsModal(props) {
  ...
  const [sponsorConfirmationShow, setSponsorConfirmationShow] = React.useState(
    false
  );
      ...
      <Modal.Body className={styles.modalBody}>
        <Row>
          <Col lg="8" xs="12">
            ...
            <Description
              description={
                (progressDetail && description) || "<span>No Description</span>"
              }
            />
                  ...
                  data={[
                    {
                      ...
                      value: progressDetail?.additionalBudget
                        ? `${icxFormat(progressDetail?.additionalBudget)} ICX`
                        : "N/A",
                    },
                    {
                      key: "Additional Time",
          ...
          <Row>
            <Col xs="12">
              ...
              >
                ...
                <b>{remainingTimer.day}</b> days <b>{remainingTimer.hour}</b>{" "}
                hours <b>{remainingTimer.minute}</b> minutes{" "}
        ...
        >
          {sponsorVote === "approve" ? (
            <>
              ...
              <div style={{ color: "red" }}>
                You will need to transfer {progressDetail.totalBudget * 0.1} ICX
                for sponsor bond.
              </div>
            </>
          ) : (
...
const mapStateToProps = (state) => ({
  ...
  approvedVoterPercentageBudgetChange: getBudgetAdjustmentApprovedVotersPercentage(
    state
  ),

  rejectedPercentageBudgetChange: getBudgetAdjustmentRejectedPercentage(state),
  rejectedVoterPercentageBudgetChange: getBudgetAdjustmentRejectedVotersPercentage(
    state
  ),
...
const mapDispatchToProps = (dispatch) => ({
  ...
  fetchVoteResultRequest: (payload) =>
    dispatch(fetchVoteResultRequest(payload)),
