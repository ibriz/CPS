      ...
      >
        <Col sm="12" className={styles.infos}>
          <Row
            ...
            style={budgetChange ? { cursor: "auto" } : {}}
          >
            ...
            <Col lg="8" xs="12" style={{ paddingLeft: "0px" }}>
              <LowerCardTitle style={{ fontSize: "14px" }}>
                {vote.prepName} ({vote.sponsorAddress?.slice(0, 4)}...
                {vote.sponsorAddress?.slice(vote.sponsorAddress.length - 4)})
              </LowerCardTitle>
            </Col>
              ...
              <Badge
                ...
                variant={
                  proposalStatusMapping.find(
                    (mapping) => mapping.name === vote.status
                  )?.badgeColor
                }
