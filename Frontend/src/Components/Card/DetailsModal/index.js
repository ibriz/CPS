...
function DetailsModal(props) {
  ...
  const [
    ...
    setSponsorVoteReasonDescription,
  ] = useState(null);
      ...
      >
        <Row>
          <Col lg="8" xs="12">
            ...
            <Description
              description={
                (proposalDetail && description) || "<span>No Description</span>"
              }
            />
            {proposal?.sponsorVoteReason && (
              <Description
                description={
                  sponsorVoteReasonDescription || "<span>No Message</span>"
                }
                  ...
                  },
                  {
                    ...
                    value: prepName ? (
                      ...
                      (
                        ...
                        >{`${proposalDetail?.sponserPrep?.slice(0, 6)}...`}</a>
                      ) || "N/A"
                    ),
                  },
                  {
              ...
              <Row style={{ justifyContent: "center" }}>
                <ButtonGroup aria-label="Basic example">
                  {sponsorVoteOptions.map((sponsorVoteOptions) => (
                    <Button
                      variant={
                        sponsorVote === sponsorVoteOptions ? "success" : "light"
                      }
...
const mapDispatchToProps = (dispatch) => ({
  fetchProposalDetail: (payload) =>
    dispatch(fetchProposalDetailRequest(payload)),
