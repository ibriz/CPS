...
import { fetchMyProposalListRequest, fetchProposalByAddressRequest } from 'Redux/Reducers/proposalSlice';
...
const ProposalPendingPRCard = ({ myProposalList, fetchMyProposalListRequest, walletAddress, totalPages, proposalStatesList, initialState, fetchDraftsRequest, history, fetchProposalByAddressRequest, proposalPendingProgressReport }) => {
    ...
    }, [selectedTab, pageNumber, fetchDraftsRequest, fetchMyProposalListRequest, walletAddress])
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ProposalPendingPRCard));